                    ...
                    <div className="about-bx wow zoomIn">
                        ...
                        <Carousel responsive={responsive} infinite={true} className="owl-carousel owl-theme about-slider">
                            <div className="item">
                                ...
                                <p>"مهدیِ تیم! علاقمند به طراحی رابط کاربری و پیاده سازی اونها در بستر وب و اپلیکیشن های موبایلی داره. توانایی حل مسئله ی بالایی داره و سعی میکنه همیشه ایده ها و طراح های به روزی رو ارائه بده. با 3 سال تجربه تو این زمینه خیلی تمیز میتونه کار رو در بیاره."</p>
                            </div>
                            <div className="item">
